...
>
> **Scope:** Template repo `workflow-orchestration-service-whiskey11` only. Issues targeting generated code (sentinel, notifier, queue) are deferred to the implementation phase.
