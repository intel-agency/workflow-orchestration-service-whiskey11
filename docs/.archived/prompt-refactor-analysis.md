...
|---|---|---|---|
| `.github/workflows/orchestrator-agent.yml` | `workflow-orchestration-service-whiskey11` | A, D | **DONE** |
| `.github/workflows/prompts/orchestrator-agent-prompt.md` | `workflow-orchestration-service-whiskey11` | B, D | **DONE** |
| `.github/.labels.json` | `workflow-orchestration-service-whiskey11` | C, D, L | **DONE** |
