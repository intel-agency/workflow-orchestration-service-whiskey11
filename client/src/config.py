...
MAX_BACKOFF: int = int(os.getenv("MAX_BACKOFF", "960"))
...
SUBPROCESS_TIMEOUT: int = int(os.getenv("SUBPROCESS_TIMEOUT", "5700"))
...
# Default: 5
HTTP_CONNECT_TIMEOUT: int = int(os.getenv("HTTP_CONNECT_TIMEOUT", "5"))

# HTTP_READ_TIMEOUT: Read timeout in seconds.
# Default: 30
HTTP_READ_TIMEOUT: int = int(os.getenv("HTTP_READ_TIMEOUT", "30"))
